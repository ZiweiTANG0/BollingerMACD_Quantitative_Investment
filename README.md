...
git clone https://github.com/YourUsername/Bollinger-MACD-Strategy.git
cd Bollinger-MACD-Strategy
...
Note: The script will automatically fetch historical data (Default: CSI 300 Index 000300.SS), run the simulation, print the trade log and summary metrics, and pop up the visualization charts.

## Disclaimer
This project is developed solely for academic research and portfolio demonstration purposes. It does not constitute financial or investment advice.
